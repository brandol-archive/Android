...
class OpPostListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        opPostList.apply {
            add(OpPost(R.drawable.demo_avatar,"작성자","게시물 이름","브랜드 추구 방향성, 문화 \n" +
                    "최근 게시글이 들어감글글글글글"))
            add(OpPost(R.drawable.demo_avatar2,"작성자","게시물 이름","브랜드 추구 방향성, 문화 \n" +
                    "최근 게시글이 들어감글글글글글"))
            add(OpPost(R.drawable.demo_avatar3,"작성자","게시물 이름","브랜드 추구 방향성, 문화 \n" +
                    "최근 게시글이 들어감글글글글글"))
            add(OpPost(R.drawable.demo_avatar4,"작성자","게시물 이름","브랜드 추구 방향성, 문화 \n" +
                    "최근 게시글이 들어감글글글글글"))
        }
